...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FeatherLibraryAccessors laccForFeatherLibraryAccessors = new FeatherLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>chuckerDebug</b> with <b>com.github.chuckerteam.chucker:library</b> coordinates and
     * with version reference <b>chucker</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getChuckerDebug() {
        return create("chuckerDebug");
    }

    /**
     * Dependency provider for <b>chuckerReleaseNoOp</b> with <b>com.github.chuckerteam.chucker:library-no-op</b> coordinates and
     * with version reference <b>chucker</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getChuckerReleaseNoOp() {
        return create("chuckerReleaseNoOp");
    }
    ...
    /**
     * Dependency provider for <b>koin</b> with <b>io.insert-koin:koin-androidx-compose</b> coordinates and
    ...
    /**
     * Group of libraries at <b>feather</b>
     */
    public FeatherLibraryAccessors getFeather() {
        return laccForFeatherLibraryAccessors;
    }
    ...
    public static class FacebookLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>login</b> with <b>com.facebook.android:facebook-login</b> coordinates and
         * with version reference <b>facebook.login</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLogin() {
            return create("facebook.login");
        }

    }

    public static class FeatherLibraryAccessors extends SubDependencyFactory {

        public FeatherLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>icons</b> with <b>br.com.devsrsouza.compose.icons:feather</b> coordinates and
         * with version reference <b>feather.icons</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getIcons() {
            return create("feather.icons");
        }
    ...
    public static class PagingLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>paging.compose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
        ...
        /**
         * Group of libraries at <b>paging.common</b>
         */
    ...
    public static class PagingCommonLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.paging:paging-common-ktx</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final FacebookVersionAccessors vaccForFacebookVersionAccessors = new FacebookVersionAccessors(providers, config);
        private final FeatherVersionAccessors vaccForFeatherVersionAccessors = new FeatherVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>chucker</b> with value <b>4.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coroutines</b> with value <b>1.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koin</b> with value <b>3.4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigation</b> with value <b>2.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesAuth</b> with value <b>19.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.facebook</b>
         */
        public FacebookVersionAccessors getFacebook() {
            return vaccForFacebookVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.feather</b>
         */
        public FeatherVersionAccessors getFeather() {
            return vaccForFeatherVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.paging</b>
         */
    ...
    public static class AccompanistVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public AccompanistVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>accompanist</b> with value <b>0.24.9-beta</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("accompanist"); }

        /**
         * Version alias <b>accompanist.pager</b> with value <b>0.20.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPager() { return getVersion("accompanist.pager"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.runtime</b> with value <b>1.5.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ConstraintlayoutVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>constraintlayout.compose</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FacebookVersionAccessors extends VersionFactory  {

        public FacebookVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>facebook.login</b> with value <b>15.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLogin() { return getVersion("facebook.login"); }

    }

    public static class FeatherVersionAccessors extends VersionFactory  {

        public FeatherVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>feather.icons</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIcons() { return getVersion("feather.icons"); }
    ...
    public static class PagingVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>paging.compose</b> with value <b>3.3.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgJetbrainsKotlinPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>org.jetbrains.kotlin.kapt</b> with plugin id <b>org.jetbrains.kotlin.kapt</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
